% FastSPM v1: SPM12 Unified Segmentation for BrainAgeR-style retraining.
%
% This is the deliberately faster non-CAT candidate. It retains the core
% representation used by BrainAgeR: bias-corrected tissue segmentation and a
% modulated, normalized grey-matter volume in MNI space. It omits CAT's SANLM,
% APP/LAS/AMAP refinements, cleanup, WMH correction, and Geodesic Shooting.
...
% warped=[unmodulated modulated], so this writes mwc1* only.
...
matlabbatch{1}.spm.spatial.preproc.tissue(3).warped = [0 1];  % CSF feasibility test: also emit mwc3
